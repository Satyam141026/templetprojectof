...
export const Footer = () => {
  return (
    <footer
    className="brk-footer brk-footer-1 position-relative"
    ...
    <div className="brk-footer__wrapper brk-footer__wrapper_shadow">
      <div className="row no-gutters">
        <div className="col-xl-6 col-12">
          <div
            className="brk-map h-100"
            data-height={520}
            data-brk-library="component__map"
          >
            <div className="brk-map__section">
              <div
                className="brk-map__canvas h-100"
                data-address="412 Throop Ave, Brooklyn, NY 11221, USA"
                data-zoom={13}
                data-type="roadmap"
                data-marker="img/gm-1.png"
                data-offset-lat="0.0047"
                data-style="silver"
                data-lat="40.6898297"
                data-lng="-73.94250620000003"
              ></div>
            </div>
            <div className="brk-map__infoicon brk-map__infoicon_layout-one text-center">
              ...
              <h4 className="font__family-montserrat font__weight-bold font__size-21 line__height-22">
                Chicago, USA
              </h4>
              ...
              <a
                href="#"
                className="btn border-radius-25 font__family-open-sans font__weight-bold btn-inside-out"
            ...
            <div className="row no-gutters">
              <div className="col-12 col-md-7">
                <div className="all-light text-center text-sm-left pt-md-80 pb-md-90 pt-40 pb-35 pl-md-60 pl-15 pr-15 pr-md-30">
                  ...
                  />
                  <p className="font__family-open-sans font__size-14 line__height-21 brk-white-font-color">
                    Cras dapibus. Vivamus elementum semper nisi. Aenean
                    vulputate eleifend tellus. Aenean leo ligula,
                    porttitor eu, consequat vitae, eleifend ac, enim.
                    Aliquam lorem ante, dapibus in, viverra fequis,
                    feugiat arutr, tellus. Phasellus viverra nulla ut
                  ...
                  <div className="d-flex flex-wrap brk-footer__info-grid flex-sm-row flex-column mb-50">
                    <p className="font__family-open-sans font__weight-bold font__size-14 mt-10">
                      <i className="brk-footer-icon text-middle fa fa-map-marker line__height-24" />
                      Chicago
                    </p>
                    <p className="font__family-open-sans font__weight-bold font__size-14 mt-10">
                      <i className="brk-footer-icon text-middle fa fa-envelope line__height-24" />
                      <a
                        href="mailto:i@nikadevs.com"
                        className="show-inline-block"
                      >
                        we@dev.com
                      </a>
                    </p>
                    <p className="font__family-open-sans font__weight-bold font__size-14 mt-10">
                      <i className="brk-footer-icon text-middle fa fa-comments line__height-24" />
                      Contact
                    </p>
                    <p className="font__family-open-sans font__weight-bold font__size-14 mt-10">
                      <i className="brk-footer-icon text-middle fa fa-phone line__height-24" />
                      <a href="#" className="show-inline-block">
                        800 12 34 567
                      </a>
                    </p>
                  </div>
              ...
              <div className="col-12 col-md-5">
                <div className="pt-80 pt-xs-20 pb-50 pr-30">
                  ...
                  <hr
                    className="horiz-line mb-40"
                    style={{ marginTop: 19 }}
                  />
                  <div className="brk-styled-twitter-3 pr-xs-15 pl-xs-15">
                    <a
                      href="https://twitter.com/We_Nikadevs"
      ...
      <div className="pt-60 brk-light-gradient-90deg-94 border-bottom-3 brk-border-color-light brk-shadow-light">
        <div className="container">
          ...
          <div
            className="brk-social-links brk-white-font-color brk-social-links_opacity d-flex justify-content-center mb-40 font__size-12"
          ...
          <div className="brk-footer__rights pt-15 pb-20 text-center">
            <p className="font__family-open-sans font__size-14 font__weight-normal line__height-14">
              © 2018 Berserk All rights reserved
            </p>
          </div>
        </div>
      </div>
